...
import (
	...
	internalinterfaces "testcontroller/pkg/client/informers/externalversions/internalinterfaces"
	v1 "testcontroller/pkg/client/listers/xfleet.com/v1"
	time "time"
)
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options meta_v1.ListOptions) (runtime.Object, error) {
				...
				return client.XfleetV1().Foos(namespace).List(options)
			},
			WatchFunc: func(options meta_v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.XfleetV1().Foos(namespace).Watch(options)
			},
		},
		&xfleet_com_v1.Foo{},
		resyncPeriod,
...
func (f *fooInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&xfleet_com_v1.Foo{}, f.defaultInformer)
}
